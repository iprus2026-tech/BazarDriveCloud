...
- **support fallback** — **design-available → `BD-RIDE-D-DISPUTE-01`** (Cloud Design render gate + `screen-contracts.md` contract now present; runtime wiring pending — no longer render-needed).

...
expect('current service worker VERSION follows the BD-RIDE-AUTHORITY-01D ride_context.js/response_store.js extraction to v295', /const\s+VERSION\s*=\s*'v295'/.test(sw));

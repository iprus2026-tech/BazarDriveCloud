...
2. Открыть сайт с cache-buster параметром, например `http://<IP>:8000/?v=v4`.
3. Если не помогло: Chrome → Настройки → Настройки сайтов → Данные сайтов → найти адрес BazarDrive → Очистить.
4. Для установленного PWA самый надёжный способ: удалить приложение с телефона и установить заново.

После очистки или переустановки должен активироваться свежий Service Worker и подтянуться новый `cloud.css`.

...
const sidebars = {
  docsSidebar: [
    ...
    },
    {
      type: 'category',
      label: 'Processes',
      items: ['processes/BD-DOCS-004', 'processes/BD-DOCS-005', 'processes/BD-DOCS-006', 'processes/BD-DOCS-040', 'processes/BD-DOCS-042'],
    },
    {
      type: 'category',
      label: 'Decisions',
      items: ['decisions/BD-DOCS-030', 'decisions/BD-DOCS-032', 'decisions/BD-DOCS-033', 'decisions/BD-DOCS-034', 'decisions/BD-DOCS-035', 'decisions/BD-DOCS-036', 'decisions/BD-DOCS-037', 'decisions/BD-DOCS-038', 'decisions/BD-DOCS-041'],
    },
    {
      type: 'category',
      label: 'Design',
